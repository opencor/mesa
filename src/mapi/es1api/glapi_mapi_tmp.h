...
void APIENTRY gl_dispatch_stub_1415(void);
void APIENTRY gl_dispatch_stub_1416(GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW);
