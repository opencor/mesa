...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1367)(GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1368)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1369)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1370)(GLenum target, GLvoid *writeOffset);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1371)(GLenum target, GLvoid *writeOffset);
